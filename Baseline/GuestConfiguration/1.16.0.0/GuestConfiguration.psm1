...
<#
    ...
    .Example
        Test-GuestConfigurationPackage -Path c:\custom_policy\WindowsTLS.zip
        ...
        Test-GuestConfigurationPackage -Path c:\custom_policy\AuditWindowsService.zip -Parameter $Parameter
...
<#
    ...
    .Example
        ...
        Protect-GuestConfigurationPackage -Path c:\custom_policy\WindowsTLS.zip -Certificate $Cert
