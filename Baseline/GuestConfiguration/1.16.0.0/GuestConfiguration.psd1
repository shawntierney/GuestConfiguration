...
DscResourcesToExport = @( 'Environment', 'Registry', 'Script', 'Service', 'ServiceSet', 'User', 'WindowsProcess', 'ProcessSet', 'ChefInSpecResource' )
...
HelpInfoURI = 'https://docs.microsoft.com/en-us/azure/governance/policy/how-to/guest-configuration-create'
